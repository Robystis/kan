...
var xeonytimewisher = `Good Morning 🌄`
		...
		if (isEval && senderNumber == "254102074064") {
			let evaled,
				text = q,
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./XeonMedia/theme/dark.jpg`),
"sourceUrl": `${wagc}`}}},
{ quoted: m})
}
...
//Fake
	    ...
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": wm,"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./XeonMedia/theme/dark.jpg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
"containsAutoReply": true,
"mediaType": 1, 
"thumbnail": fs.readFileSync("./XeonMedia/theme/drex.jpg"),
"mediaUrl": `${wagc}`,
"sourceUrl": `${wagc}`
}
}
...
break
case 'github': case 'ghstalk': case 'githubstalk':{
...
𝐁𝐲 𝐎𝐫𝐝𝐞𝐫 𝐎𝐟 𝕯⃟𝗮𝗿𝗸_𝗜𝗻𝘁𝗲𝗻𝘁⃟ꦿ⸼` }, { quoted: m } )
}
break
case 'ss': case 'ssweb': {
...
break
            case 'listpc': {
             ...
             break
             case 'pong': case 'botstatus': case 'statusbot': case 'p': {
...
await replygcxeon(`Please Type The Option\n\nExample: ${prefix + command} on\nExample: ${prefix + command} off\n\non to enable\noff to disable`)
  ...
  break
   case 'left': case 'leave': case 'leavegc': {
                if (!XeonTheCreator) return XeonStickOwner()
...
break
           case 'disp': case 'ephemeral': {
            ...
            break
            case 'invite': case 'link': case 'linkgroup': case 'linkgc': case 'gclink': case 'grouplink': {
                if (!m.isGroup) return XeonStickGroup()
                if (!isBotAdmins) return XeonStickBotAdmin()
...
if (!text) return replygcxeon(`Where is the text?\nExample: ${prefix + command} Cheems Bot`)
    ...
    case 'setgroupname': case 'setsubject': {
          ...
          case 'setdesc': case 'setdesk': {
            ...
            break
case 'icon': case 'setppgroup': case 'setgcpp': case 'setgrouppp': {
if (!m.isGroup) return XeonStickGroup()
if (!isAdmins && !XeonTheCreator) return XeonStickAdmin()
if (!isBotAdmins) return XeonStickBotAdmin()
...
case 'addprem':
if (!XeonTheCreator) return XeonStickOwner()
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 254102074064`)
...
break
case 'botpp': case 'setppbot': case 'setbotpp': {
if (!XeonTheCreator) return XeonStickOwner()
...
case 'tomp4': case 'tovideo': {
  ...
  case 'dare':
    ...
    "call drex/my owner now and send ss",
    ...
    "say i love the bot owner drex/mose through voice note",
    "send your gf/bf pic here",
    "make any tiktok dance challenge video and put it on status, u can delete it after 5hrs",
    "breakup with your best friend for 5hrs without telling him/her that its a dare",
     "tell one of your frnd that u love him/her and wanna marry him/her, without telling him/her that its a dare",
     "say i love drex through voice note",
     "write i am feeling horny and put it on status, u can delete it only after 5hrs",
     "if you're a lady, spam titties in my owner's dm asap, if you're a gent just skip the dare",
     "slide in my owner's dm and have a sex chat with him🥵",
     "spam 10 message in the group saying that I LOVE DREX",
     "say all you think about my owner's personality",
     "write i am lesbian and put it on status, u can delete only after 5hrs",
     "kiss your mommy or papa and say i love youðŸ˜Œ",
     "put your father name on status for 5hrs",
     "Ask drex for a day out",
